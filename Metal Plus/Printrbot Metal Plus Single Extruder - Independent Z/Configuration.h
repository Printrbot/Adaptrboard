...
#define CUSTOM_MACHINE_NAME "Printrbot Metal Plus 32bit"
...
#define HOTEND_OFFSET_Z { 0.0, 0 }    // (mm) relative Z-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 7, 60, }
