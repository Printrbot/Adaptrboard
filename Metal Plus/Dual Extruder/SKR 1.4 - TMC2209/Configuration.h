...
#define CUSTOM_VERSION_FILE Version_MPT.h // Path from the root directory (no quotes)
...
#define CUSTOM_MACHINE_NAME "Printrbot Metal Plus DUAL32"
...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_X_POS          { 150, 0 }  // (mm) X positions for parking the extruders
...
#define HOTEND_OFFSET_X { 0.0, 47.90 }   // (mm) relative X-offset for each nozzle
...
#define MAX_BED_POWER 240 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 63.15
  #define DEFAULT_bedKi 4.66
  #define DEFAULT_bedKd 570.84
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 102, 102 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 15, 60, 60 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 16, 70 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 150, 10000, 10000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 24.5, 0, 0 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MAX_POS), 20 }
